...
public class ITypeBindingUtils {
	 ...
	 *         otherwise false.
	 */
	public static boolean isKindOf(ITypeBinding typeBinding,
	 ...
	 * the interfaces to check for type equality.
	 * 
	 * @param typeBinding the type binding
	 * @param fullyQualifiedTypeName the fully qualified name to search for. May
	 *            be a class or an interface.
	...
	public static ITypeBinding removeSurroundingTypeLiteral(ITypeBinding typeBinding) {
		return removeSurroundingType(typeBinding, StringUtils.GUICE_TYPE_LITERAL);
	}
